...
#   - openmc_bo and openmc_ga installed as packages via pyproject.toml
...
#   - Notebooks/, environments/, openmc_bo/, openmc_ga/ and Results/ are all
...
# ── Install openmc_bo and openmc_ga as Python packages ───────────────────────
